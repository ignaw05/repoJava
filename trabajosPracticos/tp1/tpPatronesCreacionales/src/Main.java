...
public class Main {
    public static void main(String[] args) {
        ...
        // FACTORY
        System.out.println("\n--- FACTORY ---");
        Libro lib1 = LogisticaLibro.crearLibro("Martin Zorro","Alejandra Albornoz",20000,"Digital");
        Libro lib2 = LogisticaLibro.crearLibro("Don Quijote de la campera","Lucia Bustelo",35000,"FISICO");
        ...
        Usuario us3 = new Usuario.Builder()
                .setNombre("Lucia")
                .setEmail("luciaxbustelo@gmail.com")
                .setTelefono("2613900768")
                .setFechaNacimiento(LocalDate.parse("30/05/2005", DateTimeFormatter.ofPattern("dd/MM/yyyy")))
                .build();
